...
* PS gives you some insight into graphic operations (transforming coordinate systems, graphics stack), how fonts work, and printing details (CMYK, color profiles)
* the language is intended for *machine generation*, in which you write code that writes PS code. There's a mix: some PS is handwritten, and some is 
